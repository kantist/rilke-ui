...
import { RichTextConfig, richTextConfig } from '../../interfaces/rich-text';
...
export class RichTextComponent implements OnInit, ControlValueAccessor, AfterViewInit {
	...
	ngOnInit() {
		this.config.toolbarPosition = this.config.toolbarPosition ? this.config.toolbarPosition : richTextConfig.toolbarPosition;
	...
	onContentChange(element: HTMLElement | any): void {
		...
		if (typeof this.onChange === 'function') {
			this.value = this.config.sanitize || this.config.sanitize === undefined ?
