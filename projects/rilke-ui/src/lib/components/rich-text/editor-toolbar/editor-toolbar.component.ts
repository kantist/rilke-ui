import { Component, ElementRef, EventEmitter, HostListener, Inject, Input, Output, Renderer2, ViewChild, AfterViewChecked } from '@angular/core';
import { RichTextService, UploadResponse } from '../../../services/rich-text.service';
import { HttpResponse, HttpEvent } from '@angular/common/http';
import { DOCUMENT } from '@angular/common';
import { CustomClass } from '../../../interfaces/rich-text';
...
export class EditorToolbarComponent implements AfterViewChecked {
	htmlMode = false;
	linkSelected = false;
	block = 'default';
	...
	insertUrl() {
		// let url = 'https:\/\/';
		// const selection = this.richTextService.savedSelection;
		...
		// 	this.richTextService.createLink(url);
		// }
	...
	insertVideo() {
		...
		// if (url && url !== '' && url !== `https://`) {
		// 	this.richTextService.insertVideo(url);
		// }
