import { Component, OnInit, Input, Output, EventEmitter, forwardRef, HostBinding, ElementRef, HostListener } from '@angular/core';
	...
	providers: [
		{
			...
			useExisting: forwardRef(() => KATextareaComponent),
			multi: true
		}
	]
})
export class KATextareaComponent implements ControlValueAccessor, OnInit {
	@HostBinding('class.ka-textarea') true;
